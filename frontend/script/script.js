    ...
    async function fetchMaterials() {
        try {
            ...
            limitedMaterials.forEach(material => {
                ...
                card.className = "border border-gray-300 rounded-lg p-4 shadow-md transition transform hover:-translate-y-1 hover:shadow-lg bg-white flex flex-col justify-between";
